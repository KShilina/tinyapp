...
app.get("/urls/:id", (req, res) => {
  let userID = req.cookies["user_id"];
  let userData = users[userID];
  const templateVars = { id: req.params.id, longURL: urlDatabase[req.params.id],  user: userData };
...
app.post('/login', (req, res) => {
  ...
  const userObj = Object.entries(users).find(([id,user]) => user.email === username)
